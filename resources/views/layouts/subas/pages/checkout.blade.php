      ...
      <div class="row">
          ...
          <div class="col-md-10">
              ...
              <div class="coupon-discount">
                  ...
                  <input type="text" name="redeemName" value="{{$_COOKIE['redeem']}}" readonly>
                ...
                @endif
                  ...
                  <div class="form-row">
                  <div class="group">
                  <input id="card_name" class="field" placeholder="Card Holder Name" value="{{Auth::user()->name}}" />
                  </div>  
                  <div class="group">
                  <div id="card-element">
                  ...
                  Main Lobby</h6>
                  @elseif(Auth::user()->privilege == 'guest')
                  <h6 class="widget-title mb-20">
                  <input type="checkbox" value="ok" name="ShippingChkBoxBuilding1" id="ShippingChkBoxBuilding1">
                  Warehouse</h6>
                   <h6 class="widget-title mb-20">
                  ...
                  <button class="submit-btn-1 mt-30 btn-hover-1" type="submit">place order ({{$totalAmount}})</button>
                                        </form>
...
<script type="text/javascript" src="{{ asset('js/forCheckOut.js?ver=1.1') }}"></script>
<script type="text/javascript">
