...
<br>
 ...
 <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        <td><?php echo e($categorie->categoryId); ?></td>
        <td><?php echo e($categorie->categoryName); ?></td>
        <td><?php echo e(\App\Http\Controllers\SubCategoriesController::getCount($categorie->categoryId)); ?></td>
        <td>
  <button type="button" onClick="loadEditCategory('<?php echo e($categorie->categoryId); ?>');" data-toggle="modal" data-target="#myEditCatModal" class="btn btn-warning">Edit</button>
</td>
      </tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
 ...
 <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="panel panel-info">
      <div class="panel-heading"><b>ID: </b><?php echo e($categorie->categoryId); ?>

        <b> Name: </b><?php echo e($categorie->categoryName); ?>
  ...
  <table class="table table-bordered">
    ...
    <tbody>
<?php $__currentLoopData = \App\Http\Controllers\CategoriesController::forSubCategories($categorie->categoryId); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $forSubCategorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        <td><?php echo e($forSubCategorie->subCategoryId); ?></td>
        <td><?php echo e($forSubCategorie->subCategoryName); ?></td>
        <td><?php echo e(\App\Http\Controllers\CategoriesController::subCategoriesProducts($forSubCategorie->subCategoryId)); ?></td>
        <td>
        <button type="button" data-toggle="modal" onClick="loadEditSubCategory('<?php echo e($forSubCategorie->subCategoryId); ?>');" data-target="#myEditSubCatModal" class="btn btn-warning">Edit</button>
        </td>
      </tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
    </tbody>
