...
<input name="upc" type="number" id="upc" placeholder="Product UPC Num" class="form-control" required>
</div>
<div class="form-group">
...
<input name="sku" type="number" id="sku" placeholder="Product SKU Num" class="form-control" required>
</div>
    </div>
    <div class="col-sm-4">
<div class="form-group">
...
<select class="form-control" id="brand" name="brand" required>
    ...
    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($brand->brand_id); ?>"><?php echo e($brand->brandName); ?></option>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</select>
</div>
</div>
