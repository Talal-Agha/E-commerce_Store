...
<label><input type="checkbox" name="saleStatus" id="saleStatus" checked>On Sale</label>
<?php else: ?>
<label><input type="checkbox" name="saleStatus" id="saleStatus">On Sale</label>
<?php endif; ?>
</div>
</div>
<div class="form-group">
...
<label><input type="checkbox" name="availableStatus" id="availableStatus" checked>Available</label>
<?php else: ?>
<label><input type="checkbox" name="availableStatus" id="availableStatus">Available</label>
<?php endif; ?>
</div>
</div>
<div class="form-group">
