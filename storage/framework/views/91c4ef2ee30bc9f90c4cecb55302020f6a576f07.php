...
<img src="<?php echo e(asset('img/homepage/brands_cordinate.png')); ?>" class="img-responsive" alt="">
</a>
</div>
...
<img src="<?php echo e(asset('img/homepage/brands_ecosurvivor.png')); ?>" class="img-responsive" alt="">
</a>
</div>
</div>
<div class="row cat">
...
<img src="<?php echo e(asset('img/homepage/brands_enbrighten.png')); ?>" class="img-responsive" alt="">
</a>
</div>
<div class="col-md-4 col-md-offset-1 col-sm-8 col-sm-offset-2 prod-cat">
    </a>             <a href="https://epurchase.byjasco.com/categories/Cables">
<a href="/brand/8/Energizer">
    ...
    <img src="<?php echo e(asset('img/homepage/brands_energizer.png')); ?>" class="img-responsive" alt="">
</a>  
</div>
</div>
<div class="row cat">
<div class="col-md-4 col-md-offset-1 col-sm-8 col-sm-offset-2 prod-cat">
   ...
   <a href="/brand/86/GE">
    ...
    <img src="<?php echo e(asset('img/homepage/brands_ge.png')); ?>" class="img-responsive" alt="">
    </a>
</div>
<div class="col-md-4 col-md-offset-1 col-sm-8 col-sm-offset-2 prod-cat">
    </a>                 <a href="https://epurchase.byjasco.com/categories/Cables">
    <a href="/brand/75/Honeywell">   
     ...
     <img src="<?php echo e(asset('img/homepage/brands_honeywell.png')); ?>" class="img-responsive" alt="">
    </a>
    </div>
</div>]
...
<div class="col-md-4 col-md-offset-1 col-sm-8 col-sm-offset-2 prod-cat">
    ...
    <img src="<?php echo e(asset('img/homepage/brands_lightsbynight.png')); ?>" class="img-responsive" alt="">
    </a>
</div>
<div class="col-md-4 col-md-offset-1 col-sm-8 col-sm-offset-2 prod-cat">
    </a>                 <a href="https://epurchase.byjasco.com/categories/Cables">
    <a href="/brand/79/My%20Touch%20Smart">  
        ...
        <img src="<?php echo e(asset('img/homepage/brands_mytouchsmart.png')); ?>" class="img-responsive" alt="">
    </a>
    </div>
</div> 
...
<div class="col-md-4 col-md-offset-1 col-sm-8 col-sm-offset-2 prod-cat">
  ...
  <a href="/brand/68/Phillips">
    ...
    <img src="<?php echo e(asset('img/homepage/brands_philips.png')); ?>" class="img-responsive" alt="">
  </a>
</div>
<div class="col-md-4 col-md-offset-1 col-sm-8 col-sm-offset-2 prod-cat">
    </a>                 <a href="https://epurchase.byjasco.com/categories/Cables">
    <a href="/brand/33/Power%20Gear%E2%84%A2">
        ...
        <img src="<?php echo e(asset('img/homepage/brands_powergear.png')); ?>" class="img-responsive" alt="">
    </a>
    </div>
...
<div class="col-md-4 col-md-offset-1 col-sm-8 col-sm-offset-2 prod-cat">
  ...
  <a href="/brand/82/Projectables">
    ...
    <img src="<?php echo e(asset('img/homepage/brands_projectables.png')); ?>" class="img-responsive" alt="">
  </a>
</div>
<div class="col-md-4 col-md-offset-1 col-sm-8 col-sm-offset-2 prod-cat">
    </a>                 <a href="https://epurchase.byjasco.com/categories/Cables">
    <a href="/brand/83/Uber">
        ...
        <img src="<?php echo e(asset('img/homepage/brands_uber.png')); ?>" class="img-responsive" alt="">
    </a>
    </div>
</div>                                            
